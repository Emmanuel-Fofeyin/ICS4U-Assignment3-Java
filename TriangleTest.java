...
public class TriangleTest {
    public static void main(String[] args) {
        ...
        System.out.println(" → Angle 1: " + testTriangle1.angle(1) + " rad");
        System.out.println(" → Angle 2: " + testTriangle1.angle(2) + " rad");
        System.out.println(" → Angle 3: " + testTriangle1.angle(3) + " rad");
        System.out.println(" → Height 1: " + testTriangle1.height(1) + " mm");
        System.out.println(" → Height 2: " + testTriangle1.height(2) + " mm");
        System.out.println(" → Height 3: " + testTriangle1.height(3) + " mm");
        ...
        System.out.println(" → Angle 1: " + testTriangle2.angle(1) + " rad");
        System.out.println(" → Angle 2: " + testTriangle2.angle(2) + " rad");
        System.out.println(" → Angle 3: " + testTriangle2.angle(3) + " rad");
        System.out.println(" → Height 1: " + testTriangle2.height(1) + " mm");
        System.out.println(" → Height 2: " + testTriangle2.height(2) + " mm");
        System.out.println(" → Height 3: " + testTriangle2.height(3) + " mm");
        ...
        System.out.println(" → Angle 1: " + testTriangle3.angle(1) + " rad");
        System.out.println(" → Angle 2: " + testTriangle3.angle(2) + " rad");
        System.out.println(" → Angle 3: " + testTriangle3.angle(3) + " rad");
        System.out.println(" → Height 1: " + testTriangle3.height(1) + " mm");
        System.out.println(" → Height 2: " + testTriangle3.height(2) + " mm");
        System.out.println(" → Height 3: " + testTriangle3.height(3) + " mm");
        ...
        System.out.println(" → Angle 1: " + testTriangle4.angle(1) + " rad");
        System.out.println(" → Angle 2: " + testTriangle4.angle(2) + " rad");
        System.out.println(" → Angle 3: " + testTriangle4.angle(3) + " rad");
        System.out.println(" → Height 1: " + testTriangle4.height(1) + " mm");
        System.out.println(" → Height 2: " + testTriangle4.height(2) + " mm");
        System.out.println(" → Height 3: " + testTriangle4.height(3) + " mm");
        ...
        System.out.println(" → Angle 1: " + testTriangle5.angle(1) + " rad");
        System.out.println(" → Angle 2: " + testTriangle5.angle(2) + " rad");
        System.out.println(" → Angle 3: " + testTriangle5.angle(3) + " rad");
        System.out.println(" → Height 1: " + testTriangle5.height(1) + " mm");
        System.out.println(" → Height 2: " + testTriangle5.height(2) + " mm");
        System.out.println(" → Height 3: " + testTriangle5.height(3) + " mm");
